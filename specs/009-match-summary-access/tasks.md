...
- [ ] T011 Implement in-app fallback rendering for devices without ActivityRecording — edit `source/RugbySummaryView.mc` and `source/RugbyActivityRecorder.mc` as needed
