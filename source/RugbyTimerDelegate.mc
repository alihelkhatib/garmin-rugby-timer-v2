...
/* Handle primary button: confirm pending actions, start/pause/resume match and start recorder when match first starts. */
    ...
    function selectAction() as Boolean {
        ...
        System.println("RUGBY|RugbyTimerDelegate|selectAction nowMs=" + ("" + now)
        ...
        if (snap["pendingConfirmAction"] != null) {
            ...
            System.println("RUGBY|RugbyTimerDelegate|selectAction afterStart snapshotId=" + (afterStart["snapshotId"] == null ? "null" : ("" + afterStart["snapshotId"])) + " clockState=" + (afterStart["clockState"] == null ? "null" : afterStart["clockState"]) + " mainCountdownSeconds=" + (afterStart["mainCountdownSeconds"] == null ? "null" : ("" + afterStart["mainCountdownSeconds"])) + " countUpSeconds=" + (afterStart["countUpSeconds"] == null ? "null" : ("" + afterStart["countUpSeconds"])));
            ...
            System.println("RUGBY|RugbyTimerDelegate|selectAction afterPause snapshotId=" + (afterPause["snapshotId"] == null ? "null" : ("" + afterPause["snapshotId"])) + " clockState=" + (afterPause["clockState"] == null ? "null" : afterPause["clockState"]) + " countUpSeconds=" + (afterPause["countUpSeconds"] == null ? "null" : ("" + afterPause["countUpSeconds"])) + " pauseHaptic=" + (pauseHaptic ? "true" : "false"));
            ...
            System.println("RUGBY|RugbyTimerDelegate|selectAction afterResume snapshotId=" + (afterResume["snapshotId"] == null ? "null" : ("" + afterResume["snapshotId"])) + " clockState=" + (afterResume["clockState"] == null ? "null" : afterResume["clockState"]) + " countUpSeconds=" + (afterResume["countUpSeconds"] == null ? "null" : ("" + afterResume["countUpSeconds"])));
        }
...
/* Cancel pending confirmation actions. */
    ...
    function upMenuAction() as Boolean {
        var snap = _model.snapshot(System.getTimer()) as Dictionary;
        System.println("RUGBY|RugbyTimerDelegate|upMenuAction snapshotId=" + (snap["snapshotId"] == null ? "null" : ("" + snap["snapshotId"])) + " clockState=" + (snap["clockState"] == null ? "null" : snap["clockState"]));
    ...
    function downAction() as Boolean {
        var snap = _model.snapshot(System.getTimer()) as Dictionary;
        System.println("RUGBY|RugbyTimerDelegate|downAction snapshotId=" + (snap["snapshotId"] == null ? "null" : ("" + snap["snapshotId"])) + " clockState=" + (snap["clockState"] == null ? "null" : snap["clockState"]));
    ...
    function onKey(evt as WatchUi.KeyEvent) as Boolean {
        ...
        try {
            ...
            System.println("RUGBY|RugbyTimerDelegate|onKey(KeyEvent) key=" + ("" + keyNum));
        } catch (ex) {
            System.println("RUGBY|RugbyTimerDelegate|onKey EX getKey: " + ex.toString());
            try {
                keyNum = evt as Number;
                System.println("RUGBY|RugbyTimerDelegate|onKey cast evt as Number key=" + ("" + keyNum));
            } catch (ex2) {
    ...
    function handleKey(key as Number) as Boolean {
        System.println("RUGBY|RugbyTimerDelegate|handleKey key=" + ("" + key));
        ...
        System.println("RUGBY|RugbyTimerDelegate|handleKey UNHANDLED key=" + ("" + key));
        return false;
    }
...
/* Guard against invalid states before opening score menus. */
    ...
    function openScoreDialog() as Boolean {
        ...
        System.println("RUGBY|RugbyTimerDelegate|openScoreDialog push ScoreTeamMenu snapshotId=" + (snap["snapshotId"] == null ? "null" : ("" + snap["snapshotId"])) + " clockState=" + (snap["clockState"] == null ? "null" : snap["clockState"]));
    ...
    function openCardDialog() as Boolean {
        ...
        System.println("RUGBY|RugbyTimerDelegate|openCardDialog push CardTeamMenu snapshotId=" + (snap["snapshotId"] == null ? "null" : ("" + snap["snapshotId"])) + " clockState=" + (snap["clockState"] == null ? "null" : snap["clockState"]));
...
/* Forward score recording to model and request UI update. */
    ...
    function openMatchOptions() as Boolean {
        var snap = _model.snapshot(System.getTimer()) as Dictionary;
        System.println("RUGBY|RugbyTimerDelegate|openMatchOptions snapshotId=" + (snap["snapshotId"] == null ? "null" : ("" + snap["snapshotId"])) + " clockState=" + (snap["clockState"] == null ? "null" : snap["clockState"]));
...
("" +         System.println("RUGBY|RugbyTimerDelegate|showMatchSummary eventCount=" + _model.eventLog().size()));
("" +         System.println("RUGBY|RugbyTimerDelegate|showMatchSummary push_attempt eventCount=" + _model.eventLog().size()));
        try {
            WatchUi.pushView(new RugbyMatchSummaryView(_model), new RugbyMatchSummaryDelegate(), WatchUi.SLIDE_UP);
("" +             System.println("RUGBY|RugbyTimerDelegate|showMatchSummary push_success eventCount=" + _model.eventLog().size()));
        } catch (ex) {
    ...
    function openVariantMenu() as Boolean {
        ...
        System.println("RUGBY|RugbyTimerDelegate|openVariantMenu snapshotId=" + (snap["snapshotId"] == null ? "null" : ("" + snap["snapshotId"])) + " currentVariant=" + (snap["variantId"] == null ? "null" : snap["variantId"]));
